			...
			<table cellpadding="15">
				<tr>
					...
					<td>
						...
						<CE:Editor DisableAutoFormatting="true" ThemeType="Office2007" EditorWysiwygModeCss="../example.css" EditorOnPaste="Disabled" id="Editor1" Height="250px" AutoConfigure="Simple" runat="server" ></CE:Editor><BR>
					</td>
				</tr>
			</table>			
		</form>
