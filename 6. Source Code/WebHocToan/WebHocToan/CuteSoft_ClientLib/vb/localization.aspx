...
<asp:radiobuttonlist style="border:1px solid #eeeeee" BgColor="#f4f4f4" id="RadioList" Width="770" runat="server" autopostback="True" RepeatLayout="Table" RepeatColumns="4" CellPadding="2" CellSpacing="0" RepeatDirection="Horizontal" onselectedindexchanged="culture_Changed">
		...
		<asp:ListItem value="th">Thaï</asp:ListItem>
