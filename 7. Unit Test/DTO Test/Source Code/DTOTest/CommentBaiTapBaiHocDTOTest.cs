...
{
    [TestFixture]
    public class CommentBaiTapBaiHocDTOTest
    {
        /// <summary>
        /// Creates a new <see cref="CommentBaiTapBaiHocDTO"/> instance.
        /// </summary>	
        public CommentBaiTapBaiHocDTOTest()
        {
            //Add your init for this class
        }

        //Object for test
        private CommentBaiTapBaiHocDTO obj;
        ...
        public void Init()
        {
            obj = new CommentBaiTapBaiHocDTO();
        ...
        [Test]
        public void set_IDBTBaiHocTest()
        {
            //TODO Write this test
            obj.IDBTBaiHoc = 1;
            Assert.That(Is.Equals(obj.IDBTBaiHoc, 1));
        }
