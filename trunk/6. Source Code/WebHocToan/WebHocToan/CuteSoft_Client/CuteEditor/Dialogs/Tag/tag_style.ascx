...
<table border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td style="width:94px" valign="top" id="navtd">
			<%
...
var OxO6d73=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxO6d73[1],true)[OxO6d73[0]]=function (){if(event[OxO6d73[2]]){alert(element[OxO6d73[3]].cssText);} ;} ;
</script>
