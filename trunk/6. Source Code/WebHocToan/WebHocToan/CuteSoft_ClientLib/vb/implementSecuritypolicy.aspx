				...
				<tr>
					...
					<td>
						...
						<table cellpadding="8">
							<tr>
								<td>
<asp:radiobuttonlist style="BORDER:#c0c0c0 1px solid;" BgColor="#f5f5f5" id="RadioList" runat="server" autopostback="True" RepeatLayout="Table"
	RepeatColumns="3" CellPadding="2" CellSpacing="0" RepeatDirection="Horizontal" onselectedindexchanged="security_Changed">
	<asp:ListItem value="Administrators"><span style="width:100">Administrators</span></asp:ListItem>
	<asp:ListItem value="Members"><span style="width:100">Members</span></asp:ListItem>
	<asp:ListItem value="Guest"><span style="width:100">Guest</span></asp:ListItem>
	<asp:ListItem value="John"><span style="width:100">John (admin)</span></asp:ListItem>
	<asp:ListItem value="Mary"><span style="width:100">Mary (sales)</span></asp:ListItem>
	<asp:ListItem value="Tim"><span style="width:100">Tim (financial)</span></asp:ListItem>
</asp:radiobuttonlist>
								</td>
								<td style="color:red">	
