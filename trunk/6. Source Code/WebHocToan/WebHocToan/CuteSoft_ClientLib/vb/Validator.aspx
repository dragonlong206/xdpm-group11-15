			...
			<table cellpadding="15">
				<tr>
					...
					<td>
						...
						<br /><br />
						<CE:Editor id="Editor1" Height="200" runat="server" EditorWysiwygModeCss="../example.css" RenderRichDropDown="false" ThemeType="OfficeXP" DisableItemList="save" AutoConfigure="Simple" width=780></CE:Editor>
