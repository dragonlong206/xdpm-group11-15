...
<script type="text/javascript">
var OxOf6eb=["ua","userAgent","isOpera","opera","isSafari","safari","isGecko","gecko","isWinIE","msie","isMac","Mac","availWidth","dialogWidth","availHeight","dialogHeight"];var _Browser_TypeInfo=null;function Browser__InitType(){if(_Browser_TypeInfo!=null){return ;} ;var Ox4={};Ox4[OxOf6eb[0]]=navigator[OxOf6eb[1]].toLowerCase();Ox4[OxOf6eb[2]]=(Ox4[OxOf6eb[0]].indexOf(OxOf6eb[3])>-1);Ox4[OxOf6eb[4]]=(Ox4[OxOf6eb[0]].indexOf(OxOf6eb[5])>-1);Ox4[OxOf6eb[6]]=(!Ox4[OxOf6eb[2]]&&!Ox4[OxOf6eb[4]]&&Ox4[OxOf6eb[0]].indexOf(OxOf6eb[7])>-1);Ox4[OxOf6eb[8]]=(!Ox4[OxOf6eb[2]]&&Ox4[OxOf6eb[0]].indexOf(OxOf6eb[9])>-1);Ox4[OxOf6eb[10]]=navigator[OxOf6eb[1]].indexOf(OxOf6eb[11])!=-1;_Browser_TypeInfo=Ox4;} ;Browser__InitType();function Browser_IsWinIE(){return _Browser_TypeInfo[OxOf6eb[8]];} ;try{if(Browser_IsWinIE()){top.moveTo((screen[OxOf6eb[12]]-self[OxOf6eb[13]])/2,(screen[OxOf6eb[14]]-self[OxOf6eb[15]])/2);} else {} ;} catch(x){} ;
</script>
