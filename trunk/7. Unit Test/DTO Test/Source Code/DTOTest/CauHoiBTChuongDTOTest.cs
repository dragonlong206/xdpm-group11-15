...
{
    [TestFixture]
    public class CauHoiBTChuongDTOTest
    {
        /// <summary>
        /// Creates a new <see cref="CauHoiBTChuongDTO"/> instance.
        /// </summary>	
        public CauHoiBTChuongDTOTest()
        {
            //Add your init for this class
        }

        //Object for test
        private CauHoiBTChuongDTO obj;
